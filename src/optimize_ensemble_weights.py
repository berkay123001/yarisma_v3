...
MODELS = {
    ...
    'LeafNN': {
        'oof': 'Models/oof_leaf_nn.csv',
        'sub': 'Submissions/submission_leaf_nn.csv'
    },
    'Weighted': {
        'oof': 'Models/oof_weighted_lgbm.csv',
        'sub': 'Submissions/submission_weighted_lgbm.csv'
    },
    'Pade': {
        'oof': 'Models/oof_pade.csv',
        'sub': 'Submissions/submission_pade.csv'
    },
    'LeafCat': {
        'oof': 'Models/oof_leaf_catboost.csv',
        'sub': 'Submissions/submission_leaf_catboost.csv'
    }
}
...
def main():
    ...
    out_file = 'Submissions/submission_ensemble_v3.csv'
